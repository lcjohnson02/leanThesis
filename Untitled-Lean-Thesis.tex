...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{example}\NormalTok{ (s1 : ℕ → ℝ) : ConvergesTo s1 (0 : ℝ) ↔}
\NormalTok{    ConvergesTo (abs s1) (0 : ℝ) := }\KeywordTok{by}
...
\NormalTok{⊢ ConvergesTo s1 0 ↔ ConvergesTo |s1| 0}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\InformationTok{s1}\NormalTok{: ℕ → ℝ}
\NormalTok{⊢ (∀ (ε : ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |s1 n {-} 0| \textless{} ε) ↔}
\InformationTok{  ∀ (ε }\NormalTok{: ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |abs s1 n {-} 0| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    ConvergesTo (abs s1) (0 : ℝ) := }\KeywordTok{by}
  \KeywordTok{rw}\NormalTok{ [ConvergesTo]}
  \KeywordTok{rw}\NormalTok{ [ConvergesTo]}
  \KeywordTok{have}\NormalTok{ h3 (x : ℕ) : |s1 x| = |abs s1 x| := }\KeywordTok{by}
...
\begin{Highlighting}[]
\InformationTok{s1}\NormalTok{: ℕ → ℝ}
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\NormalTok{⊢ (∀ (ε : ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |s1 n {-} 0| \textless{} ε) ↔}
\InformationTok{  ∀ (ε }\NormalTok{: ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |abs s1 n {-} 0| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\InformationTok{s1}\NormalTok{: ℕ → ℝ}
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\InformationTok{h1}\NormalTok{: ∀ (ε : ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |s1 n {-} 0| \textless{} ε}
\NormalTok{⊢ ∀ (ε : ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |abs s1 n {-} 0| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\InformationTok{h1}\NormalTok{: ∀ (ε : ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |s1 n {-} 0| \textless{} ε}
\NormalTok{⊢ ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |abs s1 n| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\InformationTok{s1}\NormalTok{: ℕ → ℝ}
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\InformationTok{h1}\NormalTok{: ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |s1 n| \textless{} ε}
\NormalTok{⊢ ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |abs s1 n| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\InformationTok{h1}\NormalTok{: ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |s1 n| \textless{} ε}
\NormalTok{⊢ ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |s1 n| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\NormalTok{⊢ (∀ (ε : ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |abs s1 n {-} 0| \textless{} ε) →}
\InformationTok{  ∀ (ε }\NormalTok{: ℝ), ε \textgreater{} 0 → ∃ N, ∀ (n : ℕ), n ≥ N → |s1 n {-} 0| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\InformationTok{s1}\NormalTok{: ℕ → ℝ}
\InformationTok{h3}\NormalTok{: ∀ (x : ℕ), |s1 x| = |abs s1 x|}
\InformationTok{h1}\NormalTok{: ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |abs s1 n| \textless{} ε}
\NormalTok{⊢ ∀ (ε : ℝ), 0 \textless{} ε → ∃ N, ∀ (n : ℕ), N ≤ n → |abs s1 n| \textless{} ε}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{perhaps-a-third-great-example}{%
\section{Perhaps a Third Great
Example??}\label{perhaps-a-third-great-example}}
